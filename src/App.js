const pendingJobs = [
  { id: 1, description: "Passports", quantity: 2, sorted: true },
  { id: 2, description: "Socks", quantity: 12, sorted: false },
  { id: 1, description: "Passports", quantity: 2, sorted: true },
  { id: 2, description: "Socks", quantity: 12, sorted: false },
  { id: 1, description: "Passports", quantity: 2, sorted: true },
  { id: 2, description: "Socks", quantity: 12, sorted: false },
    ...
    <div>
      <div className="flashcards">
        {pendingJobs.map((pendingJob) => (
          <span className={pendingJob.sorted ? "selected" : ""}>
            <PendingJobFlashCard pendingJob={pendingJob} key={pendingJob.id} />
          </span>
        ))}
      </div>
    </div>
